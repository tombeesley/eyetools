...
```{r}
#standard plot
plot_AOI_growth(data = data_118, AOIs = HCL_AOIs, trial_number = 1)

#remove non-AOI data
plot_AOI_growth(data = data_118, AOIs = HCL_AOIs, trial_number = 1, keep_out_of_AOI = FALSE)

#only keep predictive and non-predictive cues rather than the target AOI
plot_AOI_growth(data = data_118, AOIs = HCL_AOIs, keep_out_of_AOI = FALSE, AOI_names = c("Predictive", "Non Predictive", NA))
