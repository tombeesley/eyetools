...
```{r}
data <- interpolate(data, maxgap = 150, method = "approx", participant_col = "pNum")
```
...
interpolate_report <- interpolate(data, maxgap = 150, method = "approx", participant_col = "pNum", report = TRUE)
...
saccades <- saccade_VTI(data, participant_col = "pNum")
