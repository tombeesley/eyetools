...
plot_seq(data, pID_values = 119, trial_values = 1, bg_image = "data/HCL_sample_image.jpg") # add background image
...
```{r}
plot_spatial(raw_data = data, pID_values = 119, trial_values = 6, trial_number = 6)
