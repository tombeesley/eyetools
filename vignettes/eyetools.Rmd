...
```{r}
plot_spatial(raw_data = data_118, trial_number = 1)

plot_spatial(fix_data = fixation_dispersion(data_118), trial_number = 1)

plot_spatial(sac_data = saccade_VTI(data_118), trial_number = 1)
