...
```{r, fig.cap='Graphic showing the raw eye gaze data imposed over a sample stimuli image.'}
...
```{r, fig.cap='Image showing single timepoint difference between raw and smoothed data'}
...
```{r, fig.cap='Image showing lagged timepoint difference between raw and smoothed data'}
...
```{r, fig.cap='Image showing the proportion of time spent in an AOI over time'}
