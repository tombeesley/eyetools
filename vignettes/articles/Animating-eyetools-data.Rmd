...
[Graphic showing the raw eye gaze data imposed over a sample stimuli image.](figures/point_lag.gif)
...
[Image showing single timepoint difference between raw and smoothed data](figures/raw_smooth_single.gif)
...
[Image showing lagged timepoint difference between raw and smoothed data](figures/raw_smooth_lag.gif)
...
[Image showing lagged timepoint difference between raw and smoothed data](figures/AOI_entry.gif)
...
[Image showing the proportion of time spent in an AOI over time](figures/data_growth_all.gif)
...
[Image showing the proportion of time spent in an AOI over time](figures/data_growth_partial.gif)
